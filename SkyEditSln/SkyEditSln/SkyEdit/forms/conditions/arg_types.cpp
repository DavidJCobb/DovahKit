...
namespace ConditionArgTypes {
   ...
   ConditionArgType     Event           = ConditionArgType("Event", ConditionArgUnderlyingType::event);
   ConditionArgType     EventData       = ConditionArgType("Event Data", ConditionArgUnderlyingType::event_data);
   ...
   ConditionArgEnumType FormType        = ConditionArgEnumType("Form Type", 0, {
      "Activator",
      "Armor",
      "Book",
      "Container",
