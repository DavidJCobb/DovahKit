...
constexpr int ESP_LOAD_WORLD_CELL_THREADS = 2;
constexpr int ESP_LOAD_TOTAL_THREADS = ESP_LOAD_SIMPLE_THREADS + ESP_LOAD_INT_CELL_THREADS + ESP_LOAD_WORLDSPACE_THREADS + ESP_LOAD_WORLD_CELL_THREADS + 1; // + 1 for the generic complex reader
