...
#include "../loaded/Form.h" // for LOAD_NAIVELY_WHEN_THE_GAME_DOES directive

void DestructionStageData::load(TESPluginSubrecord& subrecord) {
...
/*static*/ void DestructionStageData::generateUseInfo(TESPluginSubrecord& subrecord, FormStub* stub) {
   form_id_t formID;
   switch (subrecord.signature()) {
