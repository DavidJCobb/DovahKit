...
namespace dovah {
   class form_deletion_request {
      ...
      protected:
         ...
         bool             is_mid_save_cleanup = false;
         //
      ...
      public:
         form_deletion_request(file_save_passkey, load_order_processes::file_save&, form_stub& t);
      protected:
         form_deletion_request(file_load_order& o, form_stub& t);
         form_deletion_request(form_deletion_request&&) noexcept;
