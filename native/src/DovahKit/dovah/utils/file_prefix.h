   ...
   struct file_prefix {
      public:
         struct flag {
            ...
            enum : uint16_t {
               is_light               = 0x1000,
               co_opt_hardcoded_range = 0x2000,
            };
         };
         static constexpr uint16_t undefined = 0xFFFF & ~(flag::is_light | flag::co_opt_hardcoded_range);
      ...
      public:
         ...
         constexpr bool can_co_opt_hardcoded_range() const noexcept;
         
         constexpr void set_load_prefix(uint8_t v) noexcept;
         constexpr void set_light_prefix(uint16_t v) noexcept;
         constexpr void set_can_co_opt_hardcoded_range(bool) noexcept;
