...
namespace dovah {
   ...
   void form_id_t::set(form_stub* owner, bare_form_id_t set_to) {
      ...
      switch (this->type) {
         case type_t::base_form: flags |= use_info_entry::flag::object_reference; break;
         case type_t::dialogue:  flags |= use_info_entry::flag::dialogue;         break;
      }
      owner->replace_outbound_reference(this->value, set_to, flags);
      this->value = set_to;
   }
