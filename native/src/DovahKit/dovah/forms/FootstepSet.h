...
namespace dovah::loaded_forms {
   class FootstepSet : public Form {
      public:
         ...
         //
         std::vector<form_reference_t> walk_forward;
         std::vector<form_reference_t> run_forward;
         std::vector<form_reference_t> walk_forward_alt;
         std::vector<form_reference_t> run_forward_alt;
         std::vector<form_reference_t> walk_forward_alt_2;
