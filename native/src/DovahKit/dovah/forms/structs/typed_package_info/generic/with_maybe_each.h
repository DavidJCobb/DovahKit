...
namespace dovah::loaded_forms::structs::typed_package_info::generic {
   class with_maybe_each final : public base {
      public:
         with_maybe_each(legacy_type t) : type(t) {}

      public:
         const legacy_type type;
         std::optional<package_location> location; // Location 1
         std::optional<package_target>   target;   // Target 1

      public:
         virtual package_location* get_location_1() override { auto& o = this->location; return o.has_value() ? &o.value() : nullptr; };
         virtual package_location* get_location_2() override { return nullptr; };
         virtual package_target* get_target_1() override { auto& o = this->target; return o.has_value() ? &o.value() : nullptr; };
         virtual package_target* get_target_2() override { return nullptr; };
         //
         virtual void set_location_1(const package_location& v) override { this->location = v; }
