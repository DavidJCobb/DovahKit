...
namespace dovah::loaded_forms::structs::typed_package_info {
   class eat final : public base {
      public:
         static constexpr const legacy_type type = legacy_type::eat;
         static constexpr const uint32_t    header_subrecord = 'PKED';

      public:
         package_location eat_location;    // Location 1
         std::optional<package_location> search_location; // Location 2
         package_target desired_food; // Target 1

      public:
         virtual package_location* get_location_1() override { return &this->eat_location; };
         virtual package_location* get_location_2() override { auto& o = this->search_location; return o.has_value() ? &o.value() : nullptr; };
         virtual package_target* get_target_1() override { return &this->desired_food; };
         virtual package_target* get_target_2() override { return nullptr; };
         //
         virtual void set_location_1(const package_location& v) override { this->eat_location = v; }
         virtual void set_location_2(const package_location& v) override { this->search_location = v; }
         virtual void set_target_1(const package_target& v) override { this->desired_food = v; }
