...
namespace dovah::loaded_forms::structs::typed_package_info {
   class patrol final : public base {
      public:
         static constexpr const legacy_type type = legacy_type::patrol;
         static constexpr const uint32_t    header_subrecord = 'PKPT';

      public:
         package_location location;
         bool repeatable = false; // PKPT+0x00

      public:
         virtual package_location* get_location_1() override { return &this->location; };
