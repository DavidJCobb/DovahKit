...
namespace dovah::loaded_forms::structs::custom_packages {
   class package_data_bool : public package_data {
      public:
         static constexpr const char* const serialized_typename = "Bool";

      public:
         bool value = false;

      public:
         virtual package_data_type get_type() const noexcept { return package_data_type::boolean; }
         //
