...
namespace dovah::loaded_forms::structs::custom_packages {
   class package_data_float : public package_data {
      public:
         static constexpr const char* const serialized_typename = "Float";

      public:
         float value = 0;

      public:
         virtual package_data_type get_type() const noexcept { return package_data_type::float32; }
         //
