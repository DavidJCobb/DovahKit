...
namespace dovah::loaded_forms::structs::custom_packages {
   class package_data_int : public package_data {
      public:
         static constexpr const char* const serialized_typename = "Int";

      public:
         int value = 0;

      public:
         virtual package_data_type get_type() const noexcept { return package_data_type::integer; }
         //
