...
namespace dovah::loaded_forms {
   void Key::load(tes_record_reader& record, load_order_interfaces::form_load& intfc) {
   ...
   /*static*/ void Key::generate_use_info(tes_record_reader& record, form_stub_use_info_builder& uib) {
   ...
   void Key::_clone_impl(Form* out) const noexcept {
   ...
   void Key::_save_impl(tes_record_writer& record, load_order_interfaces::form_save& intfc) {
   ...
   void Key::_sever_outbound_references_impl(form_stub& other) noexcept {
      if (this->destruction_data.has_value())
