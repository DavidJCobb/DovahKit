...
namespace dovah::loaded_forms::components::extra {
   extra_data_load_result alpha_cutoff::load(tes_subrecord_reader& subrecord, load_interface_t& intfc) {
   ...
   void alpha_cutoff::save(tes_record_writer& record, save_interface_t& intfc) {
