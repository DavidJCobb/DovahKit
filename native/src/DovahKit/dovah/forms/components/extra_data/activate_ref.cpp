...
namespace dovah::loaded_forms::components::extra {
   extra_data_load_result activate_ref::load(tes_subrecord_reader& subrecord, load_interface_t& intfc) {
   ...
   void activate_ref::save(tes_record_writer& record, save_interface_t& intfc) {
   ...
   basic_extra_data* activate_ref::clone(loaded_forms::Form& clone_owner) const noexcept {
