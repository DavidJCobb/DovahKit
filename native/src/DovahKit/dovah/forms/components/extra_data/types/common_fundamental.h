...
namespace dovah::loaded_forms::components::extra_data_types {
   template<typename Self, uint32_t Signature, typename ValueType, ValueType DefaultValue = ValueType{}>
   class common_fundamental : public extra_data {
      public:
...
#include "./common_fundamental.inl"