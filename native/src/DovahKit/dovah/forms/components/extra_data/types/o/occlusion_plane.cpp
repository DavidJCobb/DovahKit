...
namespace dovah::loaded_forms::components::extra_data_types {
   /*virtual*/ subrecord_load_result occlusion_plane::load(tes_file_reading::subrecord& subrecord, load_interface_t& intfc) /*override*/ {
   ...
   /*virtual*/ record_load_result occlusion_plane::load(tes_file_reading::record& record, load_interface_t& intfc) /*override*/ {
      return record_load_result::complete;
   }
   /*virtual*/ void occlusion_plane::save(tes_file_writing::record& record, save_interface_t& intfc) /*override*/ {
   ...
   /*static*/ void occlusion_plane::generate_use_info(tes_file_reading::record& record, form_stub_use_info_builder& uib, extra_data_use_info_state& uis) {
   }
   /*virtual*/ void occlusion_plane::clear_contained_formIDs(loaded_forms::Form& my_owner) /*override*/ {
   }
   /*virtual*/ void occlusion_plane::sever_outbound_references_to(form_stub& target, loaded_forms::Form& my_owner) /*override*/ {
   }
   
   /*virtual*/ extra_data* occlusion_plane::clone(loaded_forms::Form& clone_owner) const noexcept /*override*/ {
