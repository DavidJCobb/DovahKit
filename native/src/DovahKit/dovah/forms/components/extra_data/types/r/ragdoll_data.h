...
namespace dovah::loaded_forms::components::extra_data_types {
   class ragdoll_data : public extra_data {
      public:
         static constexpr uint32_t signature_base  = 'XRGD';
         static constexpr uint32_t signature_biped = 'XRGB';

      public:
         ragdoll_data() : extra_data(all_extra_data_types::index_of_type<ragdoll_data>) {}

      public:
         std::optional<std::vector<uint8_t>>     data_rgd;
         std::optional<std::array<uint8_t, 0xC>> data_rgb;
