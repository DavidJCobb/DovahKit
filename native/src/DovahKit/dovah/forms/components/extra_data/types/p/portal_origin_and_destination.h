...
namespace dovah::loaded_forms::components::extra_data_types {
   class portal_origin_and_destination : public extra_data {
      public:
         static constexpr uint32_t signature = 'XPOD';

      public:
         portal_origin_and_destination() : extra_data(all_extra_data_types::index_of_type<portal_origin_and_destination>) {}
