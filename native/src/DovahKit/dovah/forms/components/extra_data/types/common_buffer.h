...
namespace dovah::loaded_forms::components::extra_data_types {
   template<typename Self, uint32_t Signature, size_t Size>
   class common_buffer : public extra_data {
      public:
         static constexpr uint32_t signature = Signature;

      public:
         common_buffer() : extra_data(all_extra_data_types::index_of_type<Self>) {}
