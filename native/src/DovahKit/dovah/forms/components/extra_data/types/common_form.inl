...
#define TEMPLATE_PARAMS template<typename Self, uint32_t Signature, auto Allowed> requires impl::form_type_or_array_thereof<Allowed>
#define CLASS_NAME common_form<Self, Signature, Allowed>
