...
namespace dovah::loaded_forms::components::extra {
   extra_data_load_result leveled_creature_modifier::load(tes_subrecord_reader& subrecord, load_order_interfaces::form_load& intfc) {
      if (subrecord.signature() != signature)
         return load_result::unrecognized;
      subrecord.read(this->value);
      return load_result::succeeded;
   }
   void leveled_creature_modifier::save(tes_record_writer& record) {
