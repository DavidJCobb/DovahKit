...
namespace dovah::loaded_forms::components {
   ...
   void leveled_list::clone_from(const leveled_list& original, loaded_forms::Form& my_containing_form) noexcept {
      ...
      this->chance_none.percentage = original.chance_none.percentage;
      this->chance_none.global.set(my_containing_form, original.chance_none.global);
   ...
   void leveled_list::use_info_builder::done() {
      this->owner.add_outbound_reference(this->global);
   }
}