...
namespace dovah::loaded_forms::components::papyrus {
   class package_fragment_data : public fragment_data_base {
      public:
         static constexpr const fragment_type type = fragment_type::package;
      ...
      public:
         package_fragment_data() : fragment_data_base(type) {};
         ...
         struct {
            ...
            std::optional<basic_fragment> on_change;
