      ...
      struct destruction_stage_data {
         public:
            ...
            struct Stage {
               ...
               uint8_t          damageStage   = 0;
               stage_flags_t    flags         = {};
               uint32_t         selfDamageRate = 0; // the object inflicts this much damage on itself per second (i.e. health decay)
               form_reference_t explosion;
               form_reference_t debris;
               uint32_t         debrisCount = 0;
