...
namespace dovah::loaded_forms {
   void LeveledSpell::load(tes_record_reader& record, load_order_interfaces::form_load& intfc) {
   ...
   void LeveledSpell::_clone_impl(Form* out) const noexcept {
      assert(out->type == form_type);
      auto copy = (LeveledSpell*)out;
   ...
   void LeveledSpell::_clear_impl() noexcept {
      this->bounds.clear();
      this->script_data.clear(*this);
      this->leveled_list_data.clear(*this);
   }
   void LeveledSpell::_sever_outbound_references_impl(form_stub& other) noexcept {
