...
namespace {
   ...
   constexpr const auto interpolation_offsets = []() {
      ...
      return std::array{
         ...
         offsetof(loaded_form_type, unknown[0]),
         offsetof(loaded_form_type, unknown[1]),
         offsetof(loaded_form_type, unknown[2]),
         offsetof(loaded_form_type, unknown[3]),
         offsetof(loaded_form_type, unknown[4]),
         offsetof(loaded_form_type, unknown[5]),
         offsetof(loaded_form_type, unknown[6]),
         offsetof(loaded_form_type, unknown[7]),
