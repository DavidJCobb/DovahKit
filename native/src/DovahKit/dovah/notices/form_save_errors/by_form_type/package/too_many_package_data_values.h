...
namespace dovah::notices::form_save_errors::by_type::package {
   class too_many_package_data_values : public base_list_size_too_large_to_serialize_error {
      public:
         MAKE_ERROR_OVERLOADS;
      public:
         constexpr too_many_package_data_values(form_stub& subject, size_t size)
         :
