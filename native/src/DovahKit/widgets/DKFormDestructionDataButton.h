...
class DKFormDestructionDataButton : public QWidget {
   ...
   public:
      #if !defined(QT_DESIGNER_LIB)
         using data_type = dovah::loaded_forms::components::destruction_stage_data;
      #endif
   ...
   public:
      ...
      #if !defined(QT_DESIGNER_LIB)
         void initializeFrom(const std::optional<data_type>&);
         void commitTo(std::optional<data_type>&, dovah::loaded_forms::Form& owner);
      #endif
