...
namespace editor_script::wrappers {
   struct quest : public form {
      ...
      static constexpr char* metatable_key  = "dovah.classes.quest";
      ...
      static constexpr char* alias_collection_key    = "collection<dovah.classes.quest.aliases>";
      static constexpr char* alias_id_collection_key = "collection<dovah.classes.quest.aliases_by_id>";
