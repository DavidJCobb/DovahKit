...
namespace editor_script::wrappers::resource {
   ...
   /*static*/ void cls::build_collection_metatables(lua_State* L) {
      editor_script::define_collection_metatable(L, {
         .registry_key          = cls::image_collection_key,
         .garbage_collection    = &wrapper::__gc,
         //
         .get_collection_length  = &_collections::images::get_collection_length,
         .lookup_item_by_index   = &_collections::images::lookup_item_by_index,
      });
   }
