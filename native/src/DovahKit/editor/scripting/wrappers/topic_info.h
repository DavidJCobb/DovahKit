...
namespace editor_script::wrappers {
   struct topic_info : public form {
      ...
      static constexpr char* metatable_key  = "dovah.classes.topic_info";
      ...
      static constexpr char* response_collection_key = "collection<dovah.classes.topic_info.responses>";
