...
namespace {
   ...
   namespace _getters {
      ...
      luastackchange_t checkable(lua_State* L) {
         auto& self = get_wrapper_for_thiscall<cls>(L);
         if (!self.widget)
            return 0;
         bool result = editor_script::helpers::get_widget_property((wrapped_type*)self.widget, &QGroupBox::isCheckable);
      ...
      luastackchange_t checked(lua_State* L) {
         ...
         if (!self.widget)
            return 0;
         bool result = editor_script::helpers::get_widget_property((wrapped_type*)self.widget, &QGroupBox::isChecked);
         lua_pushboolean(L, result);
         return 1;
      }
      luastackchange_t text(lua_State* L) {
         ...
         if (!self.widget)
            return 0;
         QString result = editor_script::helpers::get_widget_property((wrapped_type*)self.widget, &QGroupBox::title);
   ...
   namespace _setters {
      ...
      luastackchange_t checkable(lua_State* L) {
         ...
         editor_script::helpers::set_widget_property((wrapped_type*)self.widget, &QGroupBox::setCheckable, value);
         return 0;
      }
      luastackchange_t checked(lua_State* L) {
         auto& self = get_wrapper_for_thiscall<cls>(L);
      ...
      luastackchange_t text(lua_State* L) {
         ...
         editor_script::helpers::set_widget_property((wrapped_type*)self.widget, &QGroupBox::setTitle, value);
         return 0;
      }
   }
