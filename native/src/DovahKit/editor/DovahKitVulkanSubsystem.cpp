...
void DovahKitVulkanSubsystem::teardown() {
   ...
   vkDestroySwapchainKHR(this->devices.logical, this->swap_chain, nullptr);
   //
...
void DovahKitVulkanSubsystem::setupSwapChain() {
   ...
   //
   if (vkCreateSwapchainKHR(this->devices.logical, &create_info, nullptr, &this->swap_chain) != VK_SUCCESS) {
