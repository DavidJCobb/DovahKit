...
template<> struct cobb::bitstreams::enum_serialization_options<dovahkit::subsystems::worldinput::axis2D> {
   using value_type = dovahkit::subsystems::worldinput::axis2D;
