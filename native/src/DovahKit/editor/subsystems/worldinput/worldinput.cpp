...
namespace dovahkit::subsystems::worldinput {
   ...
   core::core() {
      ...
      #pragma region tree binds: keyboard
      {
         ...
         auto* mod_ctrl = new binds::nodes::input( // Modifier
            ...
            inputs::bound_input{
               .button = {
                  ...
                  .press_type = button_press_type::while_down,
               },
            },
            nullptr,
            true
         ...
         {  // keyboard functions: move camera
            ...
            for (const auto& b : _binds) {
               root->append(*(new binds::nodes::input(
                  tr(b.name),
                  inputs::bound_input::from_key(b.key, button_press_type::while_down),
                  func,
         ...
         {  // keyboard functions: turn camera
            ...
            root->append(*(new binds::nodes::input(
               tr("Boost"),
               inputs::bound_input::from_key(Qt::Key::Key_Shift, button_press_type::while_down),
         ...
         root->append(*(new binds::nodes::input(
            tr("Select Object"),
            inputs::bound_input::from_mouse_button(Qt::MouseButton::LeftButton, button_press_type::tap),
      ...
      #pragma region tree binds: gamepad
      {
         ...
         {  // gamepad functions: move camera
            ...
            root->append(*(new binds::nodes::input( // Down
               ...
               inputs::bound_input{
                  .button = {
                     .gamepad    = inputs::xinput_button::bumper_left,
                     .press_type = button_press_type::while_down,
                  },
               },
               func,
            ...
            root->append(*(new binds::nodes::input( // Up
               ...
               inputs::bound_input{
                  .button = {
                     .gamepad    = inputs::xinput_button::bumper_right,
                     .press_type = button_press_type::while_down,
                  },
               },
               func,
         ...
         {  // gamepad functions: boost and precision
            root->append(*(new binds::nodes::input(
               ...
               inputs::bound_input{
                  .button = {
                     .gamepad    = inputs::xinput_button::trigger_left,
                     .press_type = button_press_type::while_down,
                  },
               },
               &tools::modify_camera_speed_flags::get(),
            ...
            root->append(*(new binds::nodes::input(
               ...
               inputs::bound_input{
                  .button = {
                     .gamepad    = inputs::xinput_button::stick_click_left,
                     .press_type = button_press_type::tap,
                  },
               },
               &tools::modify_camera_speed_flags::get(),
               tools::modify_camera_speed_flags::options{
            ...
            root->append(*(new binds::nodes::input( // Hold
               ...
               inputs::bound_input{
                  .button = {
                     ...
                     .press_type = button_press_type::hold,
                  },
               },
               &tools::debug_log::get(),
               tools::debug_log::options{ .number = 1 }
         ...
         {  // Nested
            auto* node = new binds::nodes::input( // Modifier
               ...
               inputs::bound_input{
                  .button = {
                     .gamepad    = inputs::xinput_button::trigger_right,
                     .press_type = button_press_type::while_down,
                  },
               },
               nullptr,
   ...
   float core::scalarControlValue(scalar_control c, axis2D axis) const {
      switch (c) {
      ...
      auto& xi = subsystems::xinput::core::get();
   ...
   QPointF core::vectorControlValue(vector_control c) const {
      switch (c) {
   ...
   input_result core::inputResultOf(const inputs::bound_input& input) const {
      input_result result;
      if (input.is_button()) {
         bool is_while = (input.button.press_type == button_press_type::while_down);
         //
         auto& b = input.button;
         button_state kds;
         if (b.gamepad != inputs::xinput_button::none) {
   ...
   void core::ignoreAllHeldKeys(timestamp_t now) {
   ...
   void core::updateAllKeys(timestamp_t now) {
   ...
   binds::tree core::bindingsFor(input_device_type d) const {
      switch (d) {
   ...
   void core::viewFocusChange(DKVulkanView* target, bool has_focus) {
      if (has_focus) {
   ...
   void core::update(combined_tool_results& out, double& elapsed) {
      auto now = current_time();
      elapsed = elapsed_time(this->state.last_update, now);
      if (elapsed <= 0.0) {
         //
      ...
      //
      combined_tool_results instant_results;
      combined_tool_results while_results;
   ...
   void core::setTargetView(DKVulkanView* target) {
      if (this->state.target_view == target)
         return;
      this->state.target_view = target;
      this->ignoreAllHeldKeys();
   }
   DKVulkanCameraUpdate core::update(DKVulkanView* subject) {
   ...
   bool core::_isButtonProcessed(passkey_to_bind_tree, const inputs::button& button) const {
      if (button.gamepad != inputs::xinput_button::none) {
         return this->gamepad_state.is_button_processed(button);
      }
      return this->keyboard_state.is_button_processed(button);
   }
   void core::_markButtonProcessed(passkey_to_bind_tree, const inputs::button& button) {
      if (button.gamepad != inputs::xinput_button::none) {
