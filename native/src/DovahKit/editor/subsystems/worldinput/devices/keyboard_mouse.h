...
namespace dovahkit::subsystems::worldinput::devices {
   class keyboard_mouse final : public abstract_device_handler {
      ...
      public:
         ...
         //
         virtual range_control_state get_range_control_state(range_input_control, range_input_axes) const override final;
         virtual QPointF get_range_control_value(range_input_control, range_input_axes) const override final;
         //
      protected:
