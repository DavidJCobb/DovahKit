...
namespace dovahkit::subsystems::worldedit::tools {
   /*static*/ void orbit_camera::request(const tool_request_cause& input, const options_union& raw_options, tool_response_tuple& all_results) {
   ...
   /*static*/ void orbit_camera::request_for_hold_release(const options_union&, tool_response_tuple&) {
      // No-op.
   }
