...
template<> struct cobb::bitstreams::enum_serialization_options<dovahkit::subsystems::worldinput2::range_input_axes> {
   using value_type = dovahkit::subsystems::worldinput2::range_input_axes;
