...
namespace dovahkit::subsystems::form_info_cache::cached_data::by_form {
   class topic : public _base {
      public:
         static constexpr const auto form_types_of_interest = std::array{ dovah::form_type::topic };
      ...
      public:
         ...
         uint32_t subtype_signature = 0;

      public:
         void skim_record(dovah::tes_file_reading::record&);

         // Returns true if anything has changed.
         bool update(const dovah::loaded_forms::Topic&);
   };
}
