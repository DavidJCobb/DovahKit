...
class FormShoutWordEditor : public QWidget {
   Q_OBJECT;
   public:
      FormShoutWordEditor(QWidget* parent = nullptr);
      
      void load();
      void save();
      constexpr DKFormPicker* spellCombobox() const noexcept { return this->ui.spell; }
      constexpr DKFormPicker* wordCombobox() const noexcept { return this->ui.word; }
