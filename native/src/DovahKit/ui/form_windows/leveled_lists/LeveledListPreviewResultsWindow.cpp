...
LeveledListPreviewResultsWindow::LeveledListPreviewResultsWindow(QWidget* parent) : QDialog(parent) {
...
void LeveledListPreviewResultsWindow::setContents(const std::vector<dovah::leveled_list_preview::entry>& src) {
