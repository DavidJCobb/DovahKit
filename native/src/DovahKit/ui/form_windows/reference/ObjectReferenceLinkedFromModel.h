...
class ObjectReferenceLinkedFromModel : public QAbstractItemModel {
   Q_OBJECT;
   public:
      ObjectReferenceLinkedFromModel(QObject* parent = nullptr);
   ...
   protected:
      ...
      void _on_keyword_modified(dovah::form_stub&);
      void _remove_all_links_from(dovah::form_stub&);
