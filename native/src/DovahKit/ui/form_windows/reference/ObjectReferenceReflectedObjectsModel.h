...
class ObjectReferenceReflectedObjectsModel : public QAbstractItemModel {
   Q_OBJECT;
   public:
      ObjectReferenceReflectedObjectsModel(QObject* parent = nullptr);
      ...
      using extra_data_type   = dovah::loaded_forms::components::extra_data_types::reflector_refs;
   ...
   protected:
      ...
      RowType _reflection_type_via(const extra_data_type&);
      void _remove_reflection_of(dovah::form_stub&);
      void _update_reflection_of(dovah::form_stub&, RowType);
