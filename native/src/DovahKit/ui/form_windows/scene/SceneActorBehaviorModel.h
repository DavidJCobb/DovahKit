...
class SceneActorBehaviorModel : public QAbstractItemModel {
   Q_OBJECT;
   public:
      SceneActorBehaviorModel(QObject* parent = nullptr);
   ...
   protected:
      ...
      struct Actor {
         ...
         struct {
            ...
            BehaviorFlags dialogue;
            BehaviorFlags observe_corpse;
         } behavior_flags;
      };
