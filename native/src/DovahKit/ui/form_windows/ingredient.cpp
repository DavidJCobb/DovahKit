...
void FormDialogIngredient::_save_impl() {
   ...
   this->ui.effects->disconnect(); // otherwise, it'll be left with a dangling pointer that it'll use when the edit dialog boilerplate emits formModified on the ingredient
