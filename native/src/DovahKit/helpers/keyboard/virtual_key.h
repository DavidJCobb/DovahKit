...
namespace cobb::keyboard {
   ...
   enum class virtual_key : std::uint8_t {
      ...
      numpad_8          = 0x68,
      numpad_9          = 0x69,
      multiply          = 0x6A, numpad_asterisk = multiply,
      add               = 0x6B, numpad_plus     = add,
      separator         = 0x6C, numpad_comma    = separator,
      subtract          = 0x6D, numpad_minus    = subtract, numpad_dash = subtract,
      decimal           = 0x6E, numpad_period   = decimal,  numpad_decimal = decimal,
      divide            = 0x6F, numpad_slash    = divide,   numpad_divide = divide,
      f1                = 0x70,
      f2                = 0x71,
      f3                = 0x72,
      f4                = 0x73,
