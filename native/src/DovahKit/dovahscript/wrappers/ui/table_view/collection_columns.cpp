...
namespace {
   constexpr const char* collection_metatable_key = "collection<dovah.classes.ui.table_view.cols>";
}
...
namespace dovahscript::wrappers::collections {
   extern const collection_definition_params table_view_column_list = {
