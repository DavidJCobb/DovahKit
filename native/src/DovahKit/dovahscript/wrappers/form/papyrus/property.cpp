...
namespace {
   namespace _collections::_array_values {
      wrapper& get_collection_wrapper(lua_State* L) {
         auto* self = (wrapper*) classes::cast_to_class(L, 1, wrapper_t::array_collection_key);
         if (self == nullptr) {
            ...
            case pt::array_of_object:
               {
                  ...
                  return core::subsystems::userdata::get().push(L, out, wrapper_t::array_collection_key);
               }
         }
         return 0;
      }
   ...
   namespace _setters {
      ...
      int value(lua_State* L) {
         ...
         if (prop->is_array()) {
            ...
            auto* other = (wrapper*) classes::cast_to_class(L, 2, wrapper_t::array_collection_key);
            if (other) {
