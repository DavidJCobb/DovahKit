#include "DovahscriptCanvasWidgetLayerDataText.h"
#include <QPainter>
#include <QTextLayout>
...
DovahscriptCanvasWidgetLayerDataText::DovahscriptCanvasWidgetLayerDataText() {
...
void DovahscriptCanvasWidgetLayerDataText::update() {
   this->cache.size = QSize();
   DovahscriptCanvasWidgetLayerData::update();
}

void DovahscriptCanvasWidgetLayerDataText::paint_and_report(QPainter& painter, const QPoint& pos, QRectF& out_size) const noexcept {
...
void DovahscriptCanvasWidgetLayerDataText::paint(QPainter& painter, const QPoint pos, const QSize crop_to) noexcept {
   QRectF dummy;
   this->paint_and_report(painter, pos, dummy);
}
QRect DovahscriptCanvasWidgetLayerDataText::rect() const noexcept {
   //
