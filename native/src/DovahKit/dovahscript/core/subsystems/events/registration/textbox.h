   ...
   class textbox : public base {
      public:
         ...
         static constexpr const std::initializer_list<const char*> event_names = {
            "OnChanged",       // The textbox's value was altered by a keypress or other action.
            "AfterChanged",    // The textbox's value was previously altered, and the user hit Enter or moved focus away from the textbox.
