...
namespace vulkanDK::config {
   ...
   constexpr bool     sun_shadow_invert_depth     = false; // you will also have to adjust a #define in all fragment shaders that use the shadow map, to flip a comparison
   ...
   constexpr bool     light_shadow_invert_depth     = false; // you will also have to adjust a #define in all fragment shaders that use the shadow map, to flip a comparison
}