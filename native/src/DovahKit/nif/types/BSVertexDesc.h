   ...
   struct BSVertexDesc {
      struct vertex_flag {
         enum type : uint16_t {
            vertex         = (1 <<  4),
            uv             = (1 <<  5),
            uv_2           = (1 <<  6), // no impact on the file format?
            normals        = (1 <<  7),
            tangents       = (1 <<  8),
            vertex_colors  = (1 <<  9),
            skinned        = (1 << 10),
            land_data      = (1 << 11), // no impact on the file format?
            eye_data       = (1 << 12),
            instance       = (1 << 13), // no impact on the file format?
            full_precision = (1 << 14), // not used in SSE
         };
      };
