...
namespace nifDK {
   ...
   struct SkyrimShaderPropertyFlagA {
      ...
      enum type : SkyrimShaderPropertyFlags {
         ...
         non_projective_shadows     = 0x00002000, // CommonLibSSE lists this as kRefractionClamp
         landscape                  = 0x00004000,
         normal_map_is_refraction   = 0x00008000, // CommonLibSSE lists this as kRefraction
         fire_refraction            = 0x00010000, // CommonLibSSE lists this as kRefractionFalloff
         eye_environment_mapping    = 0x00020000, // requires eye shader + skinned
         hair_soft_lighting         = 0x00040000, // CommonLibSSE lists this as kHairTint
